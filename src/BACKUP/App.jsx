...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "-apple-system,'SF Pro Display','Helvetica Neue',Helvetica,sans-serif", background: W, color: T, width: "100%", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 200, height: 72, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 clamp(16px,4vw,52px)", background: scrolled ? "rgba(255,255,255,0.94)" : "rgba(255,255,255,0.80)", backdropFilter: "saturate(180%) blur(20px)", WebkitBackdropFilter: "saturate(180%) blur(20px)", borderBottom: scrolled ? "0.5px solid rgba(0,0,0,0.1)" : "0.5px solid transparent", transition: "all .3s ease" }}>
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          <button onClick={() => setChatOpen(true)} style={{ padding: "9px 22px", borderRadius: 999, border: "none", background: R, color: W, fontWeight: 600, fontSize: 14, cursor: "pointer", fontFamily: "inherit", transition: "all .2s", flexShrink: 0 }}
      ...
      <style>{`
        *,*::before,*::after { box-sizing: border-box; }
        html,body,#root { margin:0; padding:0; width:100%; max-width:100%; overflow-x:hidden; background:#ffffff; }
